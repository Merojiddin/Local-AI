...
T = {
    "en": {
        ...
        "prog_start": "Preparing…",
        "prog_load": "Loading {model} into memory…",
        "prog_part": "Synthesizing part {n} of {total}…",
        "prog_join": "Joining takes and matching loudness…",
        "prog_encode": "Encoding {fmt}…",
        "prog_done": "Finished",
    ...
    "vi": {
        ...
        "prog_start": "Đang chuẩn bị…",
        "prog_load": "Đang nạp {model} vào bộ nhớ…",
        "prog_part": "Đang tổng hợp phần {n} / {total}…",
        "prog_join": "Đang ghép các đoạn và cân âm lượng…",
        "prog_encode": "Đang mã hoá {fmt}…",
        "prog_done": "Hoàn tất",
    ...
    "zh": {
        ...
        "packaging": "正在打包结果",
        "prog_start": "正在准备……",
        "prog_load": "正在把 {model} 载入内存……",
        "prog_part": "正在合成第 {n} / {total} 段……",
        "prog_join": "正在拼接片段并统一响度……",
        "prog_encode": "正在编码 {fmt}……",
        "prog_done": "已完成",
